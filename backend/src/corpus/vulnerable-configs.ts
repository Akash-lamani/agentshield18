    ...
    files: [
      {
        ...
        content: [
          ...
          "ANTHROPIC_API_KEY=DEMO_ANTHROPIC_KEY_CORPUS_EXAMPLE",
          "",
          "OpenAI fallback: DEMO_OPENAI_KEY_CORPUS_EXAMPLE",
          "",
          "GitHub token for CI: DEMO_GITHUB_TOKEN_CORPUS_EXAMPLE",
        ].join("\n"),
        type: "claude-md",
      },
      {
        ...
        content: JSON.stringify(
          {
            mcpServers: {
              github: {
                ...
                env: {
                  GITHUB_TOKEN: "DEMO_GITHUB_TOKEN_CORPUS_EXAMPLE",
                },
              },
              supabase: {
                command: "npx",
